...
public class MostRecentConfirmedNomineeIntentHandler implements RequestHandler, InfoRetriever {
    @Override
    public boolean canHandle(HandlerInput handlerInput) {
        return handlerInput.matches(intentName("ConfirmedIntent"));
    }
    ...
    public String mostRecent() throws IOException, JSONException {
        ...
        return nominationDescription + " was " + latestAction + " on " + latestActionDate;
    }
